                ...
                <div class="admin-panel">
                    <div class="row">
                        ...
                        <div class="col-md-offset-4">
                            ...
                            <div class="modal fade bs-example-modal-sm delete-modal" tabindex="-1" role="dialog"
                            ...
                            <div class="resp-data">
                                ...
                                <div class='alert alert-warning empty-data'>Nothing to show. Please select something
                                    ex.(status, projectid and country)
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <form action="/adminpanel/projects/create" method="POST" id="create-project">
                                ...
                                <div class="form-group">
                                    <div class="multi-input">
                                        ...
                                        <input class="form-control" type="text" name="complete"
                                               id="redirect-link complete" placeholder="Vendor complete link">
                                        <input class="form-control" type="text" name="terminate"
                                               id="redirect-link terminate" placeholder="Vendor screenout link">
                                        <input class="form-control" type="text" name="quotafull"
                                               id="redirect-link quotafull" placeholder="Vendor quotafull link">
                                        <input class="form-control" type="text" name="dropoff"
                                               id="redirect-link quotafull" placeholder="Vendor drop off link">
